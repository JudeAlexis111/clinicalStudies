...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/clinicalstudies-dev-networks/regions/us-west2/subnetworks/clinicalstudies-dev-gke-subnet",
  ]
  activate_apis = [
...
module "clinicalstudies_dev" {
  ...
  domain     = "clinicalstudies-dev.clinicaltrials.mobi."
  type       = "public"
